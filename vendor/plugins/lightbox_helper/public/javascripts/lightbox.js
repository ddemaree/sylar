//  Method: show or hide show_swfs
function show_swfs(id) {
  document.getElementsByClassName('swfobject').each(function(swfobject) {
    if(id == 'all' || swfobject.up('div').id == id)
      Element.show(swfobject);
    else
      Element.hide(swfobject);
  })
}
...
Lightbox.base.prototype = {
    ...
    // closer = '<img id="close" src="/images/structure/b_close.gif" alt="Close" title="Close this window" />'
    // 
